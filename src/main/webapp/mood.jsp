...
<html lang="en">
<head>
<title>Fashion Blog a Blogging Category Bootstrap Responsive Website Template | Fashion :: w3layouts</title>    
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					...
					<li><a class="active" href="mood.mood.jsp">杂文随笔</a></li>
				...
				<div class="events w3">
					<div class="events-main">
						...
						<div class="events-top">
							<div class="col-md-6  fea-left">
								<div class="w3agile_special_deals_grid_left_grid">
									<a href="singlepage.singlepage.jsp"><img src="images/g7.jpg" class="img-responsive" alt="" /></a>
								</div>
							</div>
